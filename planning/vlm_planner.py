...
class SimplePlanner:
    ...
    def _plan_pick(self, task: str, objects: list) -> list:
        ...
        return [
            ...
            # 2. Walk to object with arm held up (FIX v3: 0.65 → 0.75 — more tolerance for 8 envs)
            {"skill": "walk_to", "params": {"target": target_obj["id"], "stop_distance": 0.75, "hold_arm": True}},
